...
export const INITIAL_SETTLEMENT_GROUPS: SettlementGroup[] = [
  {
    ...
    entries: [
      ...
      },
      {
        ...
        date: '2025-05-02',
        totalAmount: 120.5,
        type: SettlementType.RECEIVABLE,
        status: SettlementStatus.OVERDUE,
        installments: [
...
export function directionToEntryType(direction: SettlementDirection): SettlementType {
  return direction === SettlementDirection.TO_RECEIVE ? SettlementType.RECEIVABLE : SettlementType.DEBT;
}
